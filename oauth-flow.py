...
client = Client(
    ...
    # Remove or replace this detail when building your own app
...
def authorize():
    url = "{0}/oauth2/authorize?client_id={1}&scope=PAYMENTS_READ+PAYMENTS_WRITE+MERCHANT_PROFILE_READ+MERCHANT_PROFILE_WRITE+CUSTOMERS_READ+CUSTOMERS_WRITE".format(
